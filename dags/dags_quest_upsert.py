...
en_path = "/opt/airflow/tmp/quest_en_list.json"
ko_path = "/opt/airflow/tmp/quest_ko_list.json"
ja_path = "/opt/airflow/tmp/quest_ja_list.json"
...
with DAG(
    ...
    def upsert_quest(postgres_conn_id, **kwargs):
        ...
        sql = read_sql("upsert_api_quest.sql")
