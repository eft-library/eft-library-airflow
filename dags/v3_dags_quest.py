...
from custom_module.v3.quest_task_func import generate_quest_graphql, v3_quest_process
...
with DAG(
    ...
    def upsert_quest(postgres_conn_id):
        ...
        quest_sql = """
            insert into quests (id, normalized_name, name_en, name_ko, name_ja, trader_id, experience, delay_max, delay_min,
